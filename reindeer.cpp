...
void fullSpeed (int& advancement, int& miles, int& thirsty, int& tiredness, int& elvesAdvance, int& elvesMiles)
{
    ...
    cout << "\tThe elves are now " << elvesAdvance << " miles closer." << endl << endl;
    cout << "ʚ✧⃛ɞ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ʚ✧⃛ɞ\n";
}
//**************************************************************************************************************************************************
...
void rest(int& tiredness, int& elvesAdvance)
{
    ...
    cout << "\t\tThe elves are now " << elvesCreepingForward << " miles closer." << endl << endl;
    cout << "\n☆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━☆\n";
}
//**************************************************************************************************************************************************
...
void statusCheck (int& miles, int& eggnog, int& elvesMiles)
{
    ...
    cout << "\tThe elves are "<< miles - fabs(elvesMiles) << " miles behind you." << endl;
    cout << "\n___________________________________________________________\n";
}
//**************************************************************************************************************************************************
...
void surpriseWin (bool& end)
{
    ...
    if (randNum == 1)
    {
        cout << "You have found a wormhole and have managed to outrun Santa's elves!" << endl;
        cout << "Keep the reindeer, conquer this world!\t✧*｡٩(ˊᗜˋ*)و✧*｡" << endl;
        end = true;
    }
}
//**************************************************************************************************************************************************
